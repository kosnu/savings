...
when_to_read:
  ...
  - Feature Request、Task、Bug Reportの選択に迷うとき
---
...
- `Feature Request` は新しい価値または既存価値の変更を定義するIssueとして扱う。
...
リポジトリ内の関連Issueと正本文書を確認してもTaskとFeature Requestのどちらか決められない場合は、次の一点だけを確認する。

> このIssueは確定済みの上位Issueや仕様を実行する下位作業ですか、それとも新しい価値や変更を定義するFeature Requestですか？
