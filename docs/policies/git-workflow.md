...
- commit前に、AGENTS.mdで定義された必要な検証を実行する。検証が失敗したままcommitしない。
...
- レビューコメントへ対応する前に、`docs/policies/review-feedback-classification.md` に沿って分類する。
